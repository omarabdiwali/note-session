...
export default function NoteSection({ notes, title, remove, update, className }) {
  return (
    <div className={`flex-1 text-white overflow-x-auto min-h-[15rem] max-h-[15rem] min-w-[20rem] w-[30rem] max-w-[30rem] ${className} rounded-lg shadow-2xl border border-b border-white`}>
